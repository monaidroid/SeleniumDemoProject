...
public class CloudMiracle_signup 
{
	
	public static void main(String[] args)  
	{
		// Login script & Add New Company script too ...
		// Note: Create New Company by changing values in sendkeys of each text fields of Company details..
		...
		// Xpath using Regular Expression such as 'contains' word with Parent Child Tags...
		// Add Company Name
		...
		// CSS Selector using Regular Expression with Parent Child Tags...
		// Add Short Name 
		WebElement cmpShortNM = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div[id*='txtShortNm']>div>div>input")));
